...
mqtt_publish_topic = "density_cd"
# mqtt_publish_topic_2 = "emergence_vehicle"
mqtt_subscribe_topic = "traffic_light_cd"
client_id = "direction_cd"
#others
...
def callback_handler(topic, message):
    ...
    #testtestetest
#     print("test received message:", message_str)
...
#     print("f_emer = ", f_emergence)


def emergence_vehicle_run():
    global density_cd, green_time, red_time, f_red_flag
        
    #print("did i run? who tf know?")
    publish_message(client, mqtt_publish_topic, "emergence_cd")
    
    #need tested more here - sleep so central can catch up
    #utime.sleep_ms(1500)
    print("this func emergence_vehicle_run is")
...
def normal_run():
    global density_cd, green_time, red_time, f_red_flag, f_emergence, f_count_var_for_testing_normal_run
    
    f_count_var_for_testing_normal_run = f_count_var_for_testing_normal_run + 1
#     print("normal run called", f_count_var_for_testing_normal_run)
    ...
    if f_emergence == 1:
        ...
        print("run normal here")
        publish_message(client, mqtt_publish_topic, str(density_cd))
